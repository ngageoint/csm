...
namespace csm {
	...
	class CSM_EXPORT_API MultiPointCloudGM : public ObjectSpacePointCloudGM {
	...
	public:
		...
		virtual MultiModelCoord multiObjectSpaceToModel(MultiObjectSpaceCoord& groundPts,
		...
		virtual std::vector<ModelCoordCovar> multiObjectSpaceToModel(MultiObjectSpaceCoordCovar& groundPts,
			double desiredPrecision = 0.001,
			MultiDbl* achievedPrecisions = NULL,
			WarningList* warnings = NULL) const = 0;
		...
		virtual MultiObjectSpaceCoord multiModelToObjectSpace(MultiModelCoord& modelPts,
			double desiredPrecision = 0.001,
		...
		virtual MultiObjectSpaceCoordCovar multiModelToObjectSpace(MultiModelCoordCovar& modelPts,
			double desiredPrecision = 0.001,
			MultiDbl* achievedPrecisions = NULL,
			WarningList* warnings = NULL) const = 0;
		//> This method converts the given vector of modelPts (m0,m1,m2 in model
	 ...
	 //---
		...
		virtual std::vector<csm::ObjectSpacePointCloudGM::SensorPartials> multiComputeSensorPartials(int index,
			MultiObjectSpaceCoord& groundPts,
			double desiredPrecision = 0.001,
			MultiDbl* achievedPrecision = NULL,
			WarningList* warnings = NULL) const = 0;
		//> 
	   ...
	   //<
		...
		virtual std::vector<ModelPartialsVctr> multiComputeAllSensorPartials(const 
			...
			const std::vector<ObjectSpaceCoord>& groundPts,
			param::Set pSet = param::VALID,
			double desiredPrecision = 0.001,
			MultiDbl* achievedPrecision = NULL,
			WarningList* warnings = NULL) const=0;
