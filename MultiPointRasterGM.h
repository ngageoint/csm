...
namespace csm
{
class CSM_EXPORT_API MultiPointRasterGM : public ObjectSpaceRasterGM
{
public:
   MultiPointRasterGM() {}
   ...
   virtual MultiObjectSpaceVector multiGetIlluminationDirection(const MultiObjectSpaceCoord& groundPts) const = 0;
   ...
   virtual MultiObjectSpaceCoord multiGetSensorPosition(const MultiImageCoord& imagePts) const = 0;
   ...
   virtual MultiObjectSpaceCoord multiGetSensorPosition(const MultiDbl& times) const = 0;
   ...
   virtual MultiObjectSpaceVector multiGetSensorVelocity(MultiImageCoord& imagePts) const = 0;
   ...
   virtual MultiObjectSpaceVector multiGetSensorVelocity(const MultiDbl& times) const = 0;
   //> This method returns a vector of velocity of the physical sensor
   ...
   virtual MultiDblVctr multiComputeObjectSpacePartials(const MultiObjectSpaceCoord& groundPts) const = 0;
