...
public:
    ...
    //> get the protected data member that defines the specifics
    // of the object space being used by the model.
    //<
    ...
    //---
    virtual ModelCoord objectSpaceToModel(
    ...
    virtual ModelCoordCovar objectSpaceToModel(const ObjectSpaceCoordCovar& groundPt,
        double desiredPrecision = 0.001,
        double* achievedPrecision = NULL,
        WarningList* warnings = NULL) const = 0;
    ...
    //  objectSpaceToModel method with the given groundPt.
    //
    ...
    virtual std::vector<SensorPartials> computeAllSensorPartials(const ObjectSpaceCoord& groundPt,
    ...
    //
    //  Implementations with iterative algorithms (typically object space-to-model
    //  calls) will use desiredPrecision, in meters, as the convergence
    //  criterion, otherwise it will be ignored.
    //
    //  If a non-NULL achievedPrecision argument is received, it will be
    ...
    virtual std::vector<double> computeObjectSpacePartials(const ObjectSpaceCoord& groundPt) const = 0;
