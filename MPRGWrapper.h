...
public:
   ...
   MPRGWrapper(const std::shared_ptr<ObjectSpaceRasterGM>& rasterModel);
   
   virtual ~MPRGWrapper();
   
   void setRasterModel(const std::shared_ptr<ObjectSpaceRasterGM>& rasterModel);

   //***
   // MultiPointRasterGM methods.
   //***
   virtual MultiImageCoord multiObjectSpaceToImage(const MultiObjectSpaceCoord& groundPts,
   ...
   virtual MultiImageCoordCovar multiObjectSpaceToImage(const MultiObjectSpaceCoordCovar& groundPts,
                                                   double desiredPrecision = 0.001,
                                                   MultiDbl* achievedPrecisions = NULL,
                                                   WarningList* warnings = NULL) const;
   ...
   virtual MultiObjectSpaceCoord multiImageToObjectSpace(const MultiImageCoordWithHeight& pts,
   ...
   virtual MultiObjectSpaceCoordCovar multiImageToObjectSpace(
   ...
   virtual MultiObjectSpaceLocus multiImageToProximateImagingLocus(const MultiImageObjectSpaceCoordPair& imageAndGroundPts,
                                                            double desiredPrecision = 0.001,
                                                            MultiDbl* achievedPrecisions = NULL,
                                                            WarningList* warnings = NULL) const;
   ...
   virtual MultiObjectSpaceLocus multiImageToRemoteImagingLocus(const MultiImageCoord& imagePts,
                                                         double desiredPrecision = 0.001,
                                                         MultiDbl* achievedPrecisions = NULL,
                                                         WarningList* warnings = NULL) const;
   //> This method, for the given vector of imagePts (vector of line, sample in full image space
   ...
   virtual MultiObjectSpaceVector multiGetIlluminationDirection(const MultiObjectSpaceCoord& groundPts) const;
   ...
   virtual MultiObjectSpaceCoord multiGetSensorPosition(const MultiImageCoord& imagePts) const;
   ...
   virtual MultiObjectSpaceCoord multiGetSensorPosition(const MultiDbl& times) const;
   ...
   virtual MultiObjectSpaceVector multiGetSensorVelocity(MultiImageCoord& imagePts) const;
   ...
   virtual MultiObjectSpaceVector multiGetSensorVelocity(const MultiDbl& times) const;
   //> This method returns a vector of velocity of the physical sensor
   ...
   virtual MultiSensorPartialsVctr multiComputeAllSensorPartials(const MultiObjectSpaceCoord& roundPts,
   ...
   virtual MultiSensorPartialsVctr multiComputeAllSensorPartials(const MultiImageObjectSpaceCoordPair& imageAnfGroundPts,
                                                                 param::Set pSet = param::VALID,
                                                                 double desiredPrecision = 0.001,
                                                                 MultiDbl* achievedPrecision = NULL,
                                                                 WarningList* warnings = NULL) const;
   ...
   virtual MultiDblVctr multiComputeObjectSpacePartials(const MultiObjectSpaceCoord& groundPts) const;
   ...
   //<
   //---
   // ObjectSpaceRasterGM methods
   //---
   virtual CoordinateReferenceSystem getCoordinateReferenceSystem() const;
   virtual ImageCoord objectSpaceToImage(const ObjectSpaceCoord& groundPt,
                                    double desiredPrecision = 0.001,
   ...
   virtual ImageCoordCovar objectSpaceToImage(const ObjectSpaceCoordCovar& groundPt,
                                         double desiredPrecision = 0.001,
                                         double* achievedPrecision = NULL,
                                         WarningList* warnings = NULL) const;
   ...
   virtual ObjectSpaceCoord imageToObjectSpace(const ImageCoord& imagePt,
                                   const ProjectionParameters &geometry,
                                   double desiredPrecision = 0.001,
                                   double* achievedPrecision = NULL,
                                   WarningList* warnings = NULL) const;
   ...
   virtual ObjectSpaceCoordCovar imageToObjectSpace(const ImageCoordCovar& imagePt,
                                        const ProjectionParametersCovar &geometry,
                                        double desiredPrecision = 0.001,
                                        double* achievedPrecision = NULL,
                                        WarningList* warnings = NULL) const;
   ...
   virtual std::pair<double,double> getValidRangeRange() const;
   ...
   virtual ObjectSpaceVector getIlluminationDirection(const ObjectSpaceCoord& groundPt) const;
   ...
   virtual ObjectSpaceCoord getSensorPosition(const ImageCoord& imagePt) const;
      //> This method returns the position of the physical sensor
   ...
   virtual ObjectSpaceCoord getSensorPosition(double time) const;
      //> This method returns the position of the physical sensor
      //  (x,y,z meters ECEF) at the given time relative to the reference date
      //  and time given by the Model::getReferenceDateAndTime method.
      //<

   virtual ObjectSpaceVector getSensorVelocity(const ImageCoord& imagePt) const;
   ...
   virtual ObjectSpaceVector getSensorVelocity(double time) const;
      //> This method returns the velocity of the physical sensor
   ...
   virtual std::vector<double> computeObjectSpacePartials(const ObjectSpaceCoord& groundPt) const;
      //> This method returns the partial derivatives of line and sample
   ...
   //***
   virtual ObjectSpaceCoord getReferencePoint() const;
      //> This method returns the ground point indicating the general
      //  location of the image.
      //<

   virtual void setReferencePoint(const ObjectSpaceCoord& groundPt);
...
private:
   ...
   const std::shared_ptr<ObjectSpaceRasterGM>& rasterModel() const;
   //> This method returns a const reference to the owned model.
   //<
   
   std::shared_ptr<ObjectSpaceRasterGM> theRasterModel;
