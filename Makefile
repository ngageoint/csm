...
OBJS = Version.o Isd.o Plugin.o GeometricModel.o RasterGM.o ConstantCorrelationFunction.o FourParameterCorrelationFunction.o LinearDecayCorrelationFunction.o DampedCosineCorrelationFunction.o CorrelationModel.o FourParameterCorrelationModel.o LinearDecayCorrelationModel.o MultiFunctionCorrelationModel.o csmPointCloud.o PointCloudIsd.o PointCloudGM.o ModelIdentifier.o BundleGM.o Ellipsoid.o SettableEllipsoid.o MultiNitfIsd.o
